...
let apiKey = "f1bfe873bb85c6ee64589c1d";
...
const getExchangeRate = () => {
    ...
    let url = `https://v6.exchangerate-api.com/v6/f1bfe873bb85c6ee64589c1d/latest/USD`;
    fetch(url)
        ...
        .catch(() => {
            exchangeRateText.innerText = `Nesto nije u redu..`;
        });
};
